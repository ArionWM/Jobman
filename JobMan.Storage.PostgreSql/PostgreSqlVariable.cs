...
internal class PostgreSqlVariableType
{
    ...
    public PostgreSqlVariableType()
    {

    }

    public PostgreSqlVariableType(SqlDbType dbType, int lenght, int precision)
    {
        this.DbType = dbType;
        this.Lenght = lenght;
    ...
    public PostgreSqlVariableType(SqlDbType dbType, int lenght)
    {
        this.DbType = dbType;
        this.Lenght = lenght;
        this.Precision = 0;
    ...
    public PostgreSqlVariableType(SqlDbType dbType)
    {
        this.DbType = dbType;
        this.Lenght = 0;
        this.Precision = 0;
...
internal class SqlVariable : PostgreSqlVariableType
{
    object _value;
    ...
    public void Set(PostgreSqlVariableType type)
    {
